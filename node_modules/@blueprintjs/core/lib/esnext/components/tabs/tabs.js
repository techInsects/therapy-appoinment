...
export class Tabs extends AbstractPureComponent {
    constructor(props) {
        ...
        this.renderTabPanel = (tab) => {
            ...
            return (React.createElement("div", { "aria-labelledby": generateTabTitleId(this.props.id, id), "aria-hidden": id !== this.state.selectedTabId, className: classNames(Classes.TAB_PANEL, className), id: generateTabPanelId(this.props.id, id), key: id, role: "tabpanel" }, panel));
        };
