...
export class OverflowList extends React.Component {
    ...
    render() {
        const { className, collapseFrom, observeParents, style, tagName: TagName = "div", visibleItemRenderer, } = this.props;
        ...
        return (React.createElement(ResizeSensor, { onResize: this.resize, observeParents: observeParents },
            React.createElement(TagName, { className: classNames(Classes.OVERFLOW_LIST, className), style: style },
                collapseFrom === Boundary.START ? overflow : null,
                this.state.visible.map(visibleItemRenderer),
                collapseFrom === Boundary.END ? overflow : null,
                React.createElement("div", { className: Classes.OVERFLOW_LIST_SPACER, ref: ref => (this.spacer = ref) }))));
    }
    maybeRenderOverflow() {
