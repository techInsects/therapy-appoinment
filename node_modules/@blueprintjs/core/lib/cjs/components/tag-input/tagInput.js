...
var TagInput = /** @class */ (function (_super) {
    ...
    TagInput.prototype.render = function () {
        var _a = this.props, className = _a.className, disabled = _a.disabled, fill = _a.fill, inputProps = _a.inputProps, intent = _a.intent, large = _a.large, leftIcon = _a.leftIcon, placeholder = _a.placeholder, values = _a.values;
        var classes = classnames_1.default(Classes.INPUT, Classes.TAG_INPUT, (_b = {},
            ...
            _b), Classes.intentClass(intent), className);
